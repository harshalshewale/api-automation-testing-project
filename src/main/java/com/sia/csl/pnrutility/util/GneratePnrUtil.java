...
public class GneratePnrUtil {

	static Logger logger = Logger.getLogger(GneratePnrUtil.class);
	...
	public static String usedIndex="";
	
	public static void main(String[] args) {
		String sessionID = CrypticHelper.alteaSign();
		TestRunner.sessionID=sessionID;
		generateCustomisedPnr("SEAT-CIB", "Test case 1", "ramasamy", "SINMAA", "", "08OCT", "", "", "", "", "", "", "", "", "", "Y", 1, 0, 0);
		...
		try {
			...
			if (noOfAdults != 0) {
				for (int i = 0; i < noOfAdults; i++) {
					String addAdultCommand = "NM1" + " " + lastName + "/" + getRandomFirstName() + " MR";
					//String addAdultCommand = "NM1 ramasamy/logeshwari mrs";
			...
			if (noOfChilds != 0) {
				for (int i = 0; i < noOfChilds; i++) {
					String noOfChildsCommand = "NM1" + lastName + "/CHILD"+getRandomString(1)+getRandomString(2)+" MRS(CHD/14APR15)";
			...
			if (noOfAdultsWithInfants != 0) {
				for (int i = 0; i < noOfAdultsWithInfants; i++) {
					String noOfAdultsWithInfantsCommand = "NM1" + lastName + "/" + getRandomFirstName() + " MR" + "(INF /"
							+ "INFY"+getRandomString(1)+getRandomString(2)+"" + "/" + getInfantBirthDate() + ")";
			...
			DatabaseUtil.writePnrToDatabase(TestRunner.executionid, SquadName, PNR, lastName, firstLeg, secondLeg, thirdLeg, fourthLeg,
					"NA");
	...
	private static String getRandomFirstName() {
		...
		String[] firstNames = { "Harshal", "Vaibhav", "Rasith", "Thyagesh", "Bala", "Jiva", "Pawan", "Vincent", "Philip", "Tzkeen",
				...
				"PutinKumar", "TBag", "Schofield", "Sara", "Linkan" };
		int firstNameArrayLength = firstNames.length;
		IndexOfFirstName = 0 + randomNum.nextInt(firstNameArrayLength - 1);
		usedIndex=usedIndex+Integer.toString(IndexOfFirstName);
		if(usedIndex.contains(Integer.toString(IndexOfFirstName)))
		{
			IndexOfFirstName = 0 + randomNum.nextInt(firstNameArrayLength - 1);
		}
	...
	private static String getRandomString(int length) {
		...
		String randomString = new Random().ints(length, 0, chars.length()).mapToObj(i -> "" + chars.charAt(i))
